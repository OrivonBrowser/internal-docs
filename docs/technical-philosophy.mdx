...
- **Keep a discussion on it**
    It's very worth for us if you publish with transparency your work and decisions within our [**Discord**](https://discord.gg/KBqq92Ma8y) server at *#🛠️technical-chat*, this is to get live feedback from other contributors / Engineers and better clearance
...
- **Foundational Implementation**  
    ...
    *How should a Web3site/App developer should accomplish X?*  
    *How should a user interact with X? How should it look and behave?*
    *What are the specifications we want from it?*
