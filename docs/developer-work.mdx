...
Possibly the set of candidates is available in the MVP for the Dashboard, like you can se on the first picture at [**Orivon Docs**](https://docs.orivonstack.com)
