...
- **Have a clear goal before designing** Before designing any component, clearly define the goal you want to achieve.  
    ...
    This is usually available in the [Orivon Documentation](https://docs.orivonstack.com/). If something is not 100% clear, it means there is missing *Implementation* piece, so discuss it with the Founder and contributors before proceeding.
...
- **Foundational Implementation**  
    ...
    This is the top layer that defines exactly what Orivon should be.
