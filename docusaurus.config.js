...
const config = {
  ...
  url: 'https://orivonbrowser.github.io/',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/OrivonBrowser/internal-docs/tree/main',
        },
        blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/OrivonDashboardConcept.png',
      colorMode: {
        defaultMode: 'light',
        disableSwitch: false,
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/OrivonBrowser/internal-docs',
            label: 'GitHub',
            position: 'right',
          },
        ],
